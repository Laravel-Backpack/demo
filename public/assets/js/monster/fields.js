...
var monsterFields = [
    ...
    'image', // image PRO
    'address.street', 'address.country', 'sentiment.text', 'sentiment.user', 'category', 'postalboxer', 'countries', 'universes', 'bills', 'fallback_icon', 'products', 'icondummy', // relationship PRO
    // repeatable PRO
