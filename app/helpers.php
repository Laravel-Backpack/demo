...
if (!function_exists('backpack_pro_badge')) {
    ...
    {
        return '<a href="https://backpackforlaravel.com/pricing" target="_blank" class="badge badge-pill bg-primary my-1 mx-2" tabindex="-1">'.$string.'</a>';
    }
}
...
if (!function_exists('backpack_new_badge')) {
    ...
    {
        return '<span class="badge badge-pill bg-warning my-1 mx-2">'.$string.'</span>';
    }
}
...
if (!function_exists('backpack_free_badge')) {
    ...
    {
        return '<span class="badge badge-pill bg-success my-1 mx-2">'.$string.'</span>';
    }
}
