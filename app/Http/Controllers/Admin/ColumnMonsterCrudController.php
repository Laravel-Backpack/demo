...
class ColumnMonsterCrudController extends MonsterCrudController
{
    ...
    {
        $this->crud->addColumns(static::getColumnsArrayForSimpleTab());
        $this->crud->addColumns(static::getColumnsArrayForTimeAndSpaceTab());
        $this->crud->addColumns(static::getColumnsArrayForSelectsTab());
        $this->crud->addColumns(static::getColumnsArrayForRelationshipsTab());
        $this->crud->addColumns(static::getColumnsArrayForUploadsTab());
        $this->crud->addColumns(static::getColumnsArrayForWysiwygEditorsTab());
    ...
    public static function getColumnsArrayForSimpleTab()
    {
        return [
            [
                'name'              => 'text',
    ...
    public static function getColumnsArrayForTimeAndSpaceTab()
    {
        // -----------------
    ...
    public static function getColumnsArrayForRelationshipsTab()
    {
        // -----------------
        // RELATIONSHIPS tab
        // -----------------
    ...
    public static function getColumnsArrayForSelectsTab()
    {
        // -----------------
        // SELECTS tab
        // -----------------
    ...
    public static function getColumnsArrayForUploadsTab()
    {
        // -----------------
        // UPLOADS tab
        // -----------------
    ...
    public static function getColumnsArrayForWysiwygEditorsTab()
    {
        // -----------------
        // BIG TEXTS tab
        // -----------------
    ...
    public static function getColumnsArrayForMiscellaneousTab()
    {
        // -----------------
        // MISCELLANEOUS tab
        // -----------------
